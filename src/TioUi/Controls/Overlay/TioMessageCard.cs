...
public abstract class TioMessageCard : ContentControl
{
    ...
    public static readonly DirectProperty<TioMessageCard, bool> IsClosingProperty =
        AvaloniaProperty.RegisterDirect<TioMessageCard, bool>(nameof(IsClosing), o => o.IsClosing);

    public static readonly StyledProperty<bool> IsClosedProperty =
        AvaloniaProperty.Register<TioMessageCard, bool>(nameof(IsClosed));

    public static readonly StyledProperty<NotificationType> NotificationTypeProperty =
        AvaloniaProperty.Register<TioMessageCard, NotificationType>(nameof(NotificationType));

    public static readonly StyledProperty<bool> ShowIconProperty =
        AvaloniaProperty.Register<TioMessageCard, bool>(nameof(ShowIcon), true);

    public static readonly StyledProperty<IList<OperateButtonEntry>?> OperateButtonsProperty =
        AvaloniaProperty.Register<TioMessageCard, IList<OperateButtonEntry>?>(nameof(OperateButtons));

    public static readonly StyledProperty<bool> IsButtonsInlineProperty =
        AvaloniaProperty.Register<TioMessageCard, bool>(nameof(IsButtonsInline));

    public static readonly StyledProperty<NotificationEntry?> NotificationEntryProperty =
        AvaloniaProperty.Register<TioMessageCard, NotificationEntry?>(nameof(NotificationEntry));

    public static readonly StyledProperty<bool> ShowCollapseButtonProperty =
        AvaloniaProperty.Register<TioMessageCard, bool>(nameof(ShowCollapseButton));

    public static readonly StyledProperty<bool> ShowRemoveButtonProperty =
        AvaloniaProperty.Register<TioMessageCard, bool>(nameof(ShowRemoveButton), true);
