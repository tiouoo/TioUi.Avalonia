...
public partial class MultiAutoCompleteBox : TemplatedControl, IInnerContentControl, IPopupInnerContent
{
    ...
    static MultiAutoCompleteBox()
    {
        ...
        MinimumPopulateDelayProperty.Changed.AddClassHandler<MultiAutoCompleteBox>((box, args) =>
            box.OnMinimumPopulateDelayChanged(args));
        IsDropDownOpenProperty.Changed.AddClassHandler<MultiAutoCompleteBox>((box, args) =>
            box.OnIsDropDownOpenChanged(args));
        TextProperty.Changed.AddClassHandler<MultiAutoCompleteBox>((box, args) => box.OnTextPropertyChanged(args));
        SearchTextProperty.Changed.AddClassHandler<MultiAutoCompleteBox>((box, args) =>
            box.OnSearchTextPropertyChanged(args));
        FilterModeProperty.Changed.AddClassHandler<MultiAutoCompleteBox>((box, args) =>
            box.OnFilterModePropertyChanged(args));
        ItemFilterProperty.Changed.AddClassHandler<MultiAutoCompleteBox>((box, args) =>
            box.OnItemFilterPropertyChanged(args));
        ItemsSourceProperty.Changed.AddClassHandler<MultiAutoCompleteBox>((box, args) =>
            box.OnItemsSourcePropertyChanged(args));
        ItemTemplateProperty.Changed.AddClassHandler<MultiAutoCompleteBox>((box, args) =>
            box.OnItemTemplatePropertyChanged(args));
        IsEnabledProperty.Changed.AddClassHandler<MultiAutoCompleteBox>((box, args) =>
            box.OnControlIsEnabledChanged(args));
    }
    ...
    private void DropDownPopup_Closed(object? sender, EventArgs e)
    {
        ...
        if (_popupHasOpened) OnDropDownClosed(EventArgs.Empty);
    }
