...
public class DatePickerCalendarView : TemplatedControl
{
    ...
    internal static readonly DirectProperty<DatePickerCalendarView, DatePickerCalendarContext> ContextDateProperty =
        AvaloniaProperty.RegisterDirect<DatePickerCalendarView, DatePickerCalendarContext>(
    ...
    /// <summary>
    ///     Click on DatePickerCalendarYearButton in YearView.
    ...
    internal void MarkDates(DateTime? startDate = null, DateTime? endDate = null, DateTime? previewStartDate = null,
        DateTime? previewEndDate = null)
    {
        _start = startDate;
        _end = endDate;
